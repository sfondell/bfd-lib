...
Sophia Fondell
9/27/18
CS 410: Assignment 0 - Task B - getsyms_dl.c
*/
...
// Main function to dynamically load librry and call library function
int main(int argc, char *argv[]) {
	...
	// Not sure if time actually needs to be printed when we're not doing the benchmark test
	// But I left it here anyways just to be safe
